  ...
  const TRANSLATIONS = {
    en: {
      ...
      game: {
        ...
        game_over: "Game over",
        choose_piece: "Choose the piece you want to move.",
        ...
        seven_hop_question: "Do you want to seven-hop from {origin} to {target}?",
      },
      connection: {
        connected: "Connected",
    ...
    fr: {
      ...
      game: {
        ...
        choose_piece: "Choisissez le pion à déplacer.",
        choose_destination: "Choisissez la destination.",
        choose_card: "Choisissez une carte à jouer.",
        cancel_selection: "Annuler la sélection",
        returning_to_cards: "Retour à la sélection d'une carte…",
        seven_hop_question: "Voulez-vous effectuer un saut de sept de {origin} vers {target} ?",
      },
      connection: {
        connected: "Connecté",
