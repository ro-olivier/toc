(() => {
  const TRANSLATIONS = {
    en: {
      ...
      game_modes: {
        title: "Game mode",
        intro: "Choose the number of players and seating layout.",
        team_four: "Four players — 2v2",
      ...
      lobby_browser: {
        title: "Open games",
        intro: "Join a game waiting for players.",
        refresh: "Refresh",
        loading: "Loading open games…",
        none: "No games are currently waiting for players.",
        unavailable: "The open-game list is temporarily unavailable.",
        created_by: "Created by {player}",
      ...
      start: {
        ...
        resume_title: "Previous game",
        resume_description: "Continue {game} as {player}.",
        resume_button: "Rejoin {game}",
      },
      rules: {
        ...
        labels: {
          ...
          joker_kicks_pieces_on_path: "Joker kicks pieces on its path",
        ...
        descriptions: {
          ...
          joker_kicks_pieces_on_path: "When a King moves eighteen positions, every unprotected piece crossed on the way is kicked.",
      ...
      lobby: {
        ...
        errors: {
          ...
          invalid_color_count: "Please select {count} colours.",
        },
      },
      game: {
        dealer: "Dealer",
      ...
      errors: {
        ...
        invalid_creator_name: "Player names must use 1 to 40 letters, numbers, dots, hyphens, underscores or tildes, and cannot be '.' or '..'.",
      },
    },
    ...
    fr: {
      ...
      game_modes: {
        title: "Mode de jeu",
        intro: "Choisissez le nombre de joueurs et leur disposition.",
        team_four: "Quatre joueurs — 2 contre 2",
      ...
      lobby_browser: {
        ...
        intro: "Rejoignez une partie en attente de joueurs.",
        refresh: "Actualiser",
        loading: "Chargement des parties ouvertes…",
        none: "Aucune partie n'attend actuellement de joueurs.",
        unavailable: "La liste des parties ouvertes est temporairement indisponible.",
        created_by: "Créée par {player}",
      ...
      gameplay: {
        ...
        team_won: "{playerOne} et {playerTwo} ont gagné !",
        player_won: "{player} a gagné !",
      ...
      start: {
        ...
        resume_title: "Partie précédente",
        resume_description: "Continuer {game} en tant que {player}.",
        resume_button: "Rejoindre {game}",
      },
      rules: {
        ...
        labels: {
          ...
          joker_kicks_pieces_on_path: "Le Joker éjecte les pions sur son chemin",
        ...
        descriptions: {
          ...
          joker_kicks_pieces_on_path: "Lorsqu'un Joker avance de dix-huit cases, tous les pions non protégés rencontrés sur son chemin sont éjectés.",
      ...
      lobby: {
        ...
        errors: {
          ...
          invalid_color_count: "Veuillez sélectionner {count} couleurs.",
        },
      },
      game: {
        dealer: "Donneur",
      ...
      errors: {
        ...
        invalid_creator_name: "Le nom du joueur doit contenir entre 1 et 40 lettres, chiffres, points, tirets, tirets bas ou tildes, et ne peut pas être « . » ou « .. ».",
      },
    },
  };
